...
<div class="container mx-auto px-4 mt-8">
    ...
    <form action="<?= base_url('admin/rooms/create') ?>" method="post" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6 max-w-2xl">
        <?= csrf_field() ?>
        ...
        <div class="mb-4">
            ...
            <input type="file" name="image" id="image" accept="image/*" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
